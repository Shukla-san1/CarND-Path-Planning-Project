...
void PathPlanner::KeepLane(const vector<double>& map_waypoints_x, const vector<double>& map_waypoints_y, const vector<double>& map_waypoints_s, const vector<double>& previous_path_x, const vector<double>& previous_path_y, double car_x, double car_y, double car_yaw, double car_speed, double car_s, double ref_vel, int lane, vector<double>& next_x_vals, vector<double>& next_y_vals)
{
...
void PathPlanner::GetCurrentReferenceVelocity(int lane, double ego_car_s, double car_d, double car_s,
